...
bool BBox::rayIntersect(Ray& r)
{
    ...
    /*if (r._dir.z == -1) {
        std::cout << "?????" << std::endl;
        std::cout << r._dir.x << ' ' << r._dir.y << ' ' << r._dir.z << std::endl;
        std::cout << r._inv.x << ' ' << r._inv.y << ' ' << r._inv.z << std::endl;
    ...
    /*if (r._dir.z == -1) {
        std::cout << "!!!!!" << std::endl;
        std::cout << "z : " << tzmin << ' ' << tzmax << std::endl;
    }*/
    ...
    /*if (r._dir.z == -1) {
        std::cout << "@@@@" << std::endl;
        std::cout << r._tmin << ' ' << r._tmax << std::endl;
    }*/
