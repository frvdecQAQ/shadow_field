 ...
 */
inline bool rayTriangle(Ray& ray, Triangle& in, bool flip = false)
{
    /*if (ray._dir.z == -1) {
        std::cout << "tri begin" << std::endl;
        std::cout << in._v1.x << ' ' << in._v1.y << ' ' << in._v1.z << std::endl;
        std::cout << in._v2.x << ' ' << in._v2.y << ' ' << in._v2.z << std::endl;
        std::cout << in._v0.x << ' ' << in._v0.y << ' ' << in._v0.z << std::endl;
        std::cout << ray._o.x << ' ' << ray._o.y << ' ' << ray._o.z << std::endl;
    ...
    if (!flip) {
        ...
        in_flip._v2 = in._v0;
        in_flip._v1 = in._v1;
        if (rayTriangle(ray, in_flip, true))return true;
    }
