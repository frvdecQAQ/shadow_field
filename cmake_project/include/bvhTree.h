...
struct BVHNode
{
    ...
    bool hit(Ray& ray, bool flip)
    {
        ...
        if (_leaf)
        {
            ...
            return (rayTriangle(ray, *_tri1, flip));
        }

        return ((_left->hit(ray, flip)) || (_right->hit(ray, flip)));
    }
...
public:
    ...
    bool intersect(Ray& ray, bool flip = false);
